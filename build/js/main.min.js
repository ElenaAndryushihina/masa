...
var _initAccordions = require("./modules/accordions/init-accordions");
...
var _initFilter = require("./modules/filter/init-filter");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _initSliderPrograms.initProgramsSwiper)();
    (0, _initSliderNews.initNewsSwiper)();
    (0, _initSliderReviews.initReviewsSwiper)();
    (0, _initContactsMap.initContactsMap)();
    (0, _initFilter.initFilter)();
...
},{"./modules/accordions/init-accordions":3,"./modules/filter/init-filter":4,"./modules/form-validate/form":6,"./modules/maps/init-contacts-map":12,"./modules/modals/init-modals":13,"./modules/select/custom-select":16,"./modules/sliders/init-slider-hero":18,"./modules/sliders/init-slider-news":19,"./modules/sliders/init-slider-programs":20,"./modules/sliders/init-slider-reviews":21,"./utils/ios-vh-fix":24,"./utils/menu":25}],2:[function(require,module,exports){
"use strict";
...
var initFilter = function initFilter() {
  ...
  var cards = document.querySelectorAll('.news__card');
  if (buttons) {
    buttons.forEach(function (buttonActive) {
      buttonActive.addEventListener('click', function (event) {
        if (!buttonActive.classList.contains('is-active')) {
          ...
          buttons.forEach(function (buttonOther) {
            buttonOther.classList.remove('is-active');
          });
          cards.forEach(function (cardOther) {
...
var initContactsMap = function initContactsMap() {
  // указание координат
  var geoLat = 55.028527396640804; /* Широта, Latitude, lat */
  var geoLon = 82.92824989073691; /* Долгота, Longitude, lng */
...
},{"../../utils/focus-lock":22,"../../utils/scroll-lock":26}],15:[function(require,module,exports){
"use strict";
...
var initHeroSwiper = function initHeroSwiper() {
  var heroBullet = document.querySelectorAll('.hero__bullet');
  ...
  heroBullet.forEach(function (item) {
    return item.addEventListener('click', function () {
      var current = item.dataset.slide;
...
var initNewsSwiper = function initNewsSwiper() {
  return new Swiper('.news__swiper', {
    navigation: {
    ...
    pagination: {
      ...
      renderBullet: function renderBullet(index, className) {
        return "<button class=\"".concat(className, "\" type=\"button\" aria-label=\"\u041F\u0435\u0440\u0435\u0439\u0442\u0438 \u043A ").concat(index + 1, " \u0441\u043B\u0430\u0439\u0434\u0443\">").concat(index + 1, "</button>");
      }
    },
    breakpoints: {
      1200: {
...
var initProgramsSwiper = function initProgramsSwiper() {
  return new Swiper('.programs__swiper', {
    navigation: {
...
var initMenu = function initMenu() {
  var navMain = document.querySelector('[data-nav]');
